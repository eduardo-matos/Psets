...
class IntervalSetTest extends PHPUnit_Framework_TestCase
{
    ...
    public function test_intervalset_is_always_ordered()
    {
        ...
        $is1 = new IntervalSet(array($i1, $i3, $i2));
        $is2 = new IntervalSet(array($i3, $i2, $i1));
